...
public final class DaggerPaperBoxdApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends PaperBoxdApp_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.diaryEntryDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      this.followListViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
      ...
      this.writeViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 9);
    }

    @Override
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(10).put("in.paperboxd.app.ui.screens.auth.AuthViewModel", ((Provider) authViewModelProvider)).put("in.paperboxd.app.ui.screens.bookdetail.BookDetailViewModel", ((Provider) bookDetailViewModelProvider)).put("in.paperboxd.app.ui.screens.diary.DiaryEntryDetailViewModel", ((Provider) diaryEntryDetailViewModelProvider)).put("in.paperboxd.app.ui.screens.profile.FollowListViewModel", ((Provider) followListViewModelProvider)).put("in.paperboxd.app.ui.screens.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("in.paperboxd.app.ui.screens.leaderboard.LeaderboardViewModel", ((Provider) leaderboardViewModelProvider)).put("in.paperboxd.app.ui.screens.onboarding.OnboardingViewModel", ((Provider) onboardingViewModelProvider)).put("in.paperboxd.app.ui.screens.profile.ProfileViewModel", ((Provider) profileViewModelProvider)).put("in.paperboxd.app.ui.screens.search.SearchViewModel", ((Provider) searchViewModelProvider)).put("in.paperboxd.app.ui.screens.write.WriteViewModel", ((Provider) writeViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 5: // in.paperboxd.app.ui.screens.leaderboard.LeaderboardViewModel 
          return (T) new LeaderboardViewModel(singletonCImpl.userRepositoryProvider.get());

          case 6: // in.paperboxd.app.ui.screens.onboarding.OnboardingViewModel 
          ...
          case 7: // in.paperboxd.app.ui.screens.profile.ProfileViewModel 

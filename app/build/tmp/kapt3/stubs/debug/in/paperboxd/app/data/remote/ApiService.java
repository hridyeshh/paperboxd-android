...
public abstract interface ApiService {
    ...
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object deleteMe(@retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    java.util.Map<java.lang.String, ? extends java.util.List<java.lang.String>> body, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super okhttp3.ResponseBody> $completion);
    ...
    kotlin.coroutines.Continuation<? super in.paperboxd.app.domain.model.VibeSearchResponse> $completion);
    ...
    @retrofit2.http.GET(value = "api/v1/users/{username}/reading/activity")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object readingActivity(@retrofit2.http.Path(value = "username")
    @org.jetbrains.annotations.NotNull()
    java.lang.String username, @retrofit2.http.Query(value = "year")
    int year, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super in.paperboxd.app.domain.model.ReadingActivity> $completion);
